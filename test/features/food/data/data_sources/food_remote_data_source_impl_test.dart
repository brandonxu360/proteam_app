...
// Food remote data source implementation tests
void main() {
  late FakeFirebaseFirestore fakeFirebaseFirestore;
  late FoodRemoteDataSourceImpl foodRemoteDataSource;
  ...
  group('create food', () {
    test('should create a new food in Firestore', () async {
      ...
      // * Act
      await foodRemoteDataSource.createFood(foodModel);
  ...
  group('delete food', () {
    test('should delete a food from Firestore', () async {
      ...
      // Act
      await foodRemoteDataSource.deleteFood(foodModel);
