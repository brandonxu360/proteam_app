...
import 'package:proteam_app/features/log/presentation/pages/log_food_page.dart';
...
class OnGenerateRoute {
  static Route<dynamic>? route(RouteSettings settings) {
    ...
    switch (name) {
      ...
      case RouteConst.logFoodPage:
        {
          if (args is FoodEntity) {
            return materialPageBuilder(LogFoodPage(food: args));
          } else {
            return materialPageBuilder(const ErrorPage());
          }
        }
